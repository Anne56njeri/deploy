        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <br>
                    <button class="button" style="background-color:black; width:130px;border: 2px solid black;"><span><a href="{{ url('/stage') }}" style="color:white; font-size:13px;">View Proposal </a></span></button>
